    ...
    <header className="sticky top-0 z-50 bg-light-100">
      ...
      >
        <Link href="/" aria-label="Nike Home" className="flex items-center">
          <Image src="/logoCat.png" alt="Meaw" width={100} height={100} priority className="" />
        </Link>
          ...
          {currentUser ? (
            <details ref={profileDropdownRef} className="relative">
              ...
              <div className="absolute right-0 mt-2 w-64 rounded-xl border border-light-300 bg-light-100 p-3 shadow-sm">
                ...
                <Link
                  href="/edit-profile"
                  className="mt-3 flex items-center gap-1.5 text-caption text-dark-700 hover:text-dark-900"
                  onClick={() => {
                    if (profileDropdownRef.current) profileDropdownRef.current.open = false;
                  }}
                >
        ...
        <ul className="space-y-2 px-4 py-3">
          ...
          {currentUser ? (
            <li className="pt-2 text-body text-dark-900">
              ...
              <Link
                href="/edit-profile"
                className="mt-2 flex items-center gap-1.5 text-caption text-dark-700 hover:text-dark-900"
                onClick={() => setOpen(false)}
              >
                <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" className="h-3.5 w-3.5">
                  <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
