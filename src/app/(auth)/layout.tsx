      ...
      <section className="hidden lg:flex flex-col justify-between bg-dark-900 text-light-100 p-10">
        <div className="flex items-center">
          <div className="h-8 w-8 rounded-md bg-orange inline-flex items-center justify-center">
            <Image src="/logocat.png" alt="Meaw" width={150} height={150} />
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <p className="max-w-md text-lead text-light-300">
            Join millions of athletes and fitness enthusiasts who trust Meaw for their performance needs.
          </p>
        ...
        <p className="text-footnote text-light-400">© 2025 Meaw. All rights reserved.</p>
      </section>
